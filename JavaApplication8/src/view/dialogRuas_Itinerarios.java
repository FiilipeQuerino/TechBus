 ...
 * @author Jadso
 */
public class dialogRuas_Itinerarios extends javax.swing.JDialog {
    //1-criar o dao
     ...
     */
    public dialogRuas_Itinerarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Quantidade de pontos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogRuas_Itinerarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogRuas_Itinerarios dialog = new dialogRuas_Itinerarios(new javax.swing.JFrame(), true);
