 ...
 * @author Jadso
 */
public class dialogOnibus extends javax.swing.JDialog {
    //1-criar o dao
    private daoOnibus dao = new daoOnibus();
    ...
    private void fillComponents(Onibus onibus){
        textCodigo.setText(onibus.getId()+"");
     ...
     */
    public dialogOnibus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        listOnibus = new javax.swing.JList();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(textModelo, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addGap(26, 26, 26)
                        .addComponent(textPlaca, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        listOnibus.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        listOnibus.setToolTipText("Selecione o Registro para Editar ou Remover");
        listOnibus.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                listOnibusMouseClicked(evt);
            }
        });
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(listOnibus, javax.swing.GroupLayout.PREFERRED_SIZE, 293, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(31, 31, 31)
                .addComponent(listOnibus, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void buttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        ...
        try{
            Onibus onibus = this.createOnibus();
    ...
    private void buttonRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoverActionPerformed
        // TODO add your handling code here:
        if (listOnibus.getSelectedIndex()== -1){
        ...
        try{
            Onibus onibus = (Onibus)listOnibus.getSelectedValue();
            dao.delete(onibus);
            //refresh
            this.clearComponents();
            this.loadList();
    ...
    private void listOnibusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listOnibusMouseClicked
        // TODO add your handling code here:
        Onibus onibus = (Onibus)listOnibus.getSelectedValue();
        this.fillComponents(onibus);
    }//GEN-LAST:event_listOnibusMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogOnibus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogOnibus dialog = new dialogOnibus(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JList listOnibus;
